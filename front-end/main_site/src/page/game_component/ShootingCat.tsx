...
const ShootingCat = ({ user, setUser }: { [key: string]: any }) => {
    class Sound {
        ...
        static backgroundSoundPlay() {
            ...
            Sound.backgroundSound.volume = 0.2 * Sound.mainSound;
    ...
    class Fish {
        ...
        constructor(startX: number, startY: number) {
            ...
            this._fishAudio.volume = .1 * Sound.mainSound;
    ...
    class Villain {
        ...
        constructor() {
            ...
            this._attackSound.volume = .3 * Sound.mainSound;
        }
        get X() {
            return this._x;
        }
    ...
    class BonusLife {
        ...
        constructor() {
            ...
            this._bonusLifeSound.volume = .3 * Sound.mainSound;
        }
        get X() {
            return this._x;
        }
    ...
    class Game {
        ...
        private _setScore: Dispatch<SetStateAction<number>>;
        private _backgroundChangeTime: number;
        private _time: number;

        constructor(setGameState: Dispatch<SetStateAction<string>>, setScore:Dispatch<SetStateAction<number>>) {
        ...
        lifeRender() {
            if (this._life === 0) {
                ...
                this._setScore(this._gameScore);
            }
            if (this._ctx !== null) {
            ...
            this._fishList.forEach((fish: Fish) => {
                ...
                while (i < this._villainList.length) {
                    ...
                    if (villain.Y >= this._height - 47) {
                        ...
                        damageSound.volume = .2 * Sound.mainSound;
                        damageSound.play();
                    }
                    i++;
                }
    ...
    useEffect(() => {
        ...
        if (gameState === "start") {
            let gameObject: Game | null = new Game(setGameState, setScore);
            gameObject.setGame();
    ...
    const content = {
        ...
        "end": <div id="gameDisplay" className="endDisplay">
            <div className="gameScoreoBox">
                <img src={`${gameImageSrc}/score.png`} alt="" />
                <div>{gameScore}</div>
            </div>
            <div className="buttonBox">
                <button onClick={() => { setGameState("start") }}
